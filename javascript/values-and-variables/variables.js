let firstName = "David"; // Deklarace a inicializace proměnné
let lastName; // Deklarace proměnné, v tuto chvíli nemá žádnou hodnotu (je undefined)
lastName = "Medek"; // Inicializace proměnné (nastavení hodnoty)
console.log(firstName); // Vypíše hodnotu proměnné firstName: David
