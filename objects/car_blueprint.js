export class CarBlueprint {
  constructor(color, engine, fuel, carName) {
    ...
    this.wheels = 4; // ? Hardocdovaná property - někdy Magic number
    console.log(
  ...
  getEngine() {
    return this.engine; // ? Return vrací hodnotu jako výsledek medetody/funkce
    // ! za příkazem return se již neprovádí žádné příkazy (je to finální kron funkce/metody)
